...
ACCOUNT = HOSPITAL_ACCOUNTS["hospital_1"]["address"]
PRIVATE_KEY = HOSPITAL_ACCOUNTS["hospital_1"]["private_key"]
...
ARTIFACT_JSON = (
    BASE_DIR.parent / "artifacts" / "contracts" / "MediChainFL.sol" / "MediChainFL.json"
)
...
def get_reputation(hospital_address):
    ...
    successful, flagged, score = contract.functions.getReputation(
        hospital_address
    ).call()
    return {"successful": successful, "flagged": flagged, "score": score}
